...
def get_facerender_data(coeff_path, pic_path ,first_coeff_path, audio_path, 
                        ...
                        expression_scale=1.0, still_mode = False, preprocess='crop', size = 256, pic_path_full=''):
    ...
    img1_full = Image.open(pic_path_full)
    ...
    if 'full' not in preprocess.lower():
        ...
        source_semantics_full = source_semantics_dict['coeff_3dmm_full'][:1,:70]         #1 70
