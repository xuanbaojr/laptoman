...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256, pic_path_source = ''):
       ...
       # os.remove(new_audio_path)
        ...
        if 'haha' in preprocess.lower():
          ...
          #  return_path = full_video_path
            paste_pic(final_video_path, pic_path_source, crop_info, new_audio_path, full_video_path, extended_crop= True if 'ext' in preprocess.lower() else False)
